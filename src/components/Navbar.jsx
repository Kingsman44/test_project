...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 px-4 py-2 mt-4 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'
      }`}>
                    ...
                    <div className="absolute top-full right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2">
                      {locations.map((location) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2 hover:bg-primary-50 transition-colors ${selectedLocation === location ? 'text-primary-600 bg-primary-50' : 'text-gray-700'
                            }`}
                        >
                          {location}
                        </button>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {locations.map((location) => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-lg text-sm ${selectedLocation === location
